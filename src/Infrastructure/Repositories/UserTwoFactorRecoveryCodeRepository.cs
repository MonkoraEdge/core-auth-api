...
public class UserTwoFactorRecoveryCodeRepository : BaseRepository<AuthenticationDbContext, UserTwoFactorRecoveryCode>, IUserTwoFactorRecoveryCodeRepository
{
