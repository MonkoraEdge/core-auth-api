...
namespace MonkoraEdge.Core.Auth.Infrastructure.Migrations
{
    ...
    [Migration("20260501071842_AddRefreshTokenAbsoluteExpiry")]
    partial class AddRefreshTokenAbsoluteExpiry
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MonkoraEdge.Core.Auth.Domain.AggregatesModel.EntityAggregate.RefreshToken", b =>
                {
                    ...
                    b.HasIndex("AbsoluteExpiresAt")
                        .HasDatabaseName("ix_tx_authorization_refresh_tokens_absolute_expires_at");
